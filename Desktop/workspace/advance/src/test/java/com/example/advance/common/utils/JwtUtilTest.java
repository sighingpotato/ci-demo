...
import static com.example.advance.common.utils.JwtUtil.BEARER_PREFIX;
...
class JwtUtilTest {
    ...
    // JWT 토큰 생성해주는 메서드
    @Test
    @DisplayName("JWT 토큰 생성 시 username과 role 정보가 정상적으로 포함되었는지 테스트")
    void generateToken_정상케이스() {

        // given
        String username = "kim";
        UserRoleEnum role = UserRoleEnum.ADMIN;
        String fail_username = "dong";
        ...
        // then
        // 1단계 jwtToken 시작이 Bearer로 시작하는지 검증
    ...
    // JWT 토큰이 정상적인지 이를 검사하는 것을 테스트 할 것.
